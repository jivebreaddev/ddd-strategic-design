...
import kitchenpos.external.infra.purgomalum.PurgomalumClient;
...
class MenuServiceTest {
    ...
    void setUp() {
        ...
        menuService = new MenuServiceImpl(menuRepository, menuGroupRepository, productRepository, purgomalumClient);
