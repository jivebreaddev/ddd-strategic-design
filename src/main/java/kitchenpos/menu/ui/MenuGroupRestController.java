...
import kitchenpos.menu.application.MenuGroupServiceImpl;
...
public class MenuGroupRestController {
    private final MenuGroupServiceImpl menuGroupService;

    public MenuGroupRestController(final MenuGroupServiceImpl menuGroupService) {
